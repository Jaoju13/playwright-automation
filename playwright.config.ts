...
export default defineConfig({
  ...
  /*จำนวนเครื่องรัน test : CI ทีละ 1, เครื่องเราพร้อมกันได้ เช่น A หยิบไฟล์เคส 1-2 B หยิบ 3-4 แต่ CI จะเป็น A 1-4 / undefined พร้อมๆกันไปเลอ ให้Playwright จะใช้จำนวน CPU core อัตโนมัติ
